...
if [ ! -d "/home/senekowitsch/Thesis/PopCoGenomeS/output_alt_outgroups_rerun" ]; then
    mkdir -p /home/senekowitsch/Thesis/PopCoGenomeS/output_alt_outgroups_rerun
    echo "Created output directory."
else
    echo "Directory /home/senekowitsch/Thesis/PopCoGenomeS/output_alt_outgroups_rerun already exists."
fi
...
OUTPUT_DIR="/home/senekowitsch/Thesis/PopCoGenomeS/output_alt_outgroups_rerun"
...
# Rename files in 00_data_alt_outgroups to [ID]_genome.fna
for file in GC*_*_genomic.fna; do
    ...
    mv "$file" "${short_id_no_zeros}genome.fna"

    echo "Renamed: $file -> ${short_id_no_zeros}genome.fna"
done
...
rm -r proc/
#rm -r output/
rm -r /home/senekowitsch/Thesis/PopCoGenomeS/output_alt_outgroups_rerun/*
...
rm -rf /data/Unit_LMM/selberherr-group/senekowitsch/Thesis/PopCoGenomeS/temp_4/*
